...
public class FinalWinningScreen implements Screen {

    private final MazeRunnerGame game;
    private final Stage stage;
    private final Skin skin;

    public FinalWinningScreen(MazeRunnerGame game) {
        this.game = game;
    ...
    private void createUI() {
        ...
        TextButton winningLabel = new TextButton("Congratulations!", winningStyle);
